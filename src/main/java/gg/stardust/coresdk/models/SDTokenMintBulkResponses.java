 ...
 * list of tokenIds
 */
@Schema(description = "list of tokenIds")
...
public class SDTokenMintBulkResponses extends ArrayList<Integer> implements Serializable{
  ...
  public String toString() {
    ...
    sb.append("class SDTokenMintBulkResponses {\n");
